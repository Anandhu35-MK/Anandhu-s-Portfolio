...
Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aut quam tempora nemo, placeat minima vero facilis mollitia sapiente doloribus fuga a quia velit, corrupti et, nam eius sunt expedita id!          </p>
        ...
        <div className="hero-image-wrapper">
            <div className='hero-image-container'>
                <img src={"pic1"} alt="Anandhu - Client" clasaName="hero-image"/>
                <div className="hero-image-backdrop">
                </div>
            </div>
            <div className='hero-pp'>
                <h2 className="hero-pp-title">Anandhu Mahadev MK</h2>
                <p className="hero-pp-subtitle">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae aliquam atque tenetur saepe quidem voluptatem, voluptatum voluptate? Deserunt placeat aliquid eaque enim accusamus maxime nobis accusantium quo, obcaecati sequi dolores.
                </p>
                pep
            </div>
